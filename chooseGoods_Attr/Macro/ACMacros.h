...
// 随机色
#define LXRandomColor HX_RGB(arc4random_uniform(256), arc4random_uniform(256), arc4random_uniform(256))
...
#define kFont [UIFont systemFontOfSize:9]

#define kURLScheme @"dongcheng123456"
